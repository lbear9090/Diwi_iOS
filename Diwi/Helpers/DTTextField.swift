...
public class DTTextField: UITextField {
    ...
    public var TFborderWidth:CGFloat                          = 1.0{
        didSet{
    ...
    public var dtborderStyle:DTBorderStyle = .rounded{
        didSet{
            ...
            case .rounded:
                ...
                dtLayer.borderWidth         = TFborderWidth
                dtLayer.borderColor         = TFborderColor.cgColor
            case .sqare:
                dtLayer.cornerRadius        = 0.0
                dtLayer.borderWidth         = TFborderWidth
                dtLayer.borderColor         = TFborderColor.cgColor
            case .bottom,.left,.right,.top:
                dtLayer.cornerRadius        = 0.0
                dtLayer.borderWidth         = 0.0
                borderLayer.backgroundColor = TFborderColor.cgColor
                if dtborderStyle == .bottom {
                    borderLayer.frame = CGRect(x: 0, y: dtLayer.bounds.size.height - TFborderWidth, width: dtLayer.bounds.size.width, height: TFborderWidth)
                }else if dtborderStyle == .left{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: TFborderWidth, height: dtLayer.bounds.size.height)
                }else if dtborderStyle == .right{
                    borderLayer.frame = CGRect(x: dtLayer.bounds.size.width - TFborderWidth, y: 0, width: TFborderWidth, height: dtLayer.bounds.size.height)
                }else{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: dtLayer.bounds.size.width, height: TFborderWidth)
                }
    ...
    public var errorFont = UIFont.Diwi.placeHolder{
        didSet{
    ...
    public var TFborderColor:UIColor = UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0){
        didSet{
            switch dtborderStyle {
